  ...
  return (
    <>
          ...
          <section className="totals-container" style={{breakInside: 'avoid', pageBreakInside: 'avoid'}}>
            <div className="left-totals">
             ...
             <table className="right-totals boxed-summary-table">
                <tbody>
                    <tr><td>Total Amount:</td><td className="val-total-amount">₹{totalAmount.toFixed(2)}</td></tr>
                    ...
                    <tr className="font-bold"><td>Total:</td><td className="val-total">₹{totalAfterPrevious.toFixed(2)}</td></tr>
                    {totalReceived > 0 ? (<tr><td>Total Received:</td><td className="val-total-received">₹{totalReceived.toFixed(2)}</td></tr>) : null}
                    <tr className="font-bold"><td>Final Balance:</td><td className="val-final-balance">₹{finalBalance.toFixed(2)}</td></tr>
                </tbody>
            </table>
          </section>
      ...
      <style jsx global>{`
        ...
        .val-net-amount { font-size: 12pt !important; }
        .val-total { font-size: 12pt !important; }
        .val-final-balance { font-size: 12pt !important; }
